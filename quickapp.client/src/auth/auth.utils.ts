...
//we need to control that Owner cannot delete owner role
//Also, Admin cannot delete owner role and admin role
//Manager cannot delete owner role ,admin role ,manager role and user role 
...
//Manager cannot change owner role ,admin role ,manager role and user role 
